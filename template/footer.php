    ...
    <footer id="footer">
        ...
        <div id="footer_content_copyright">
        <p><small>copyright &copy; <span id="copyright"></span> All right reserved | <span class="foundation">justice foundation &cross;</span></small></p>
        </div>
    </footer>
